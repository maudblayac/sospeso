 ...
 */
final class Version20240828130652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, categories_id INT NOT NULL, restaurant_id INT NOT NULL, price NUMERIC(10, 2) NOT NULL, picture VARCHAR(280) NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_D34A04ADA21214B7 (categories_id), INDEX IDX_D34A04ADB1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE restaurant (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(80) NOT NULL, phone_number VARCHAR(20) NOT NULL, address VARCHAR(200) NOT NULL, email VARCHAR(255) NOT NULL, website VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, title VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_EB95123FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_profile (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(60) NOT NULL, date_of_birth DATE NOT NULL, phone_number VARCHAR(20) NOT NULL, address VARCHAR(100) NOT NULL, city VARCHAR(50) NOT NULL, country VARCHAR(100) NOT NULL, postal_code VARCHAR(8) NOT NULL, update_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_D95AB405A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
